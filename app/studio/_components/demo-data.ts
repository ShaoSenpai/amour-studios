...
function member(opts: {
  ...
  const purchase: Member["purchase"] = {
    ...
    paidAt: createdAt,
    tier: opts.tier,
    duree: opts.tier === "coaching" ? (opts.duree ?? "3mois") : undefined,
...
export const listMembers: Members = [
  ...
  member({ key: "lena", discordUsername: "lena__rmr", name: "Léna R.", tier: "coaching", duree: "3mois", status: "active", stage: "feedback_analyse", phone: "+33 6 22 11 09 87", inscritDaysAgo: 62, lastActiveMs: 1 * DAY, periodEndDays: 7 }),
  ...
  member({ key: "kira", discordUsername: "kira.ldn", name: "Kira N.", tier: "coaching", duree: "3mois", status: "active", stage: "contenu", phone: "+33 6 78 91 02 33", inscritDaysAgo: 92, lastActiveMs: 4 * HOUR, periodEndDays: 7 }),
  ...
  member({ key: "amir", discordUsername: "amir.flow", name: "Amir F.", tier: "coaching", duree: "3mois", status: "active", stage: "contenu", phone: "+33 6 87 33 12 09", inscritDaysAgo: 31, lastActiveMs: 18 * DAY, periodEndDays: 16 }),
  ...
  member({ key: "octave", discordUsername: "octave.fm", name: "Octave M.", tier: "coaching", duree: "3mois", status: "active", stage: "positionnement", phone: "+33 6 22 09 87 33", inscritDaysAgo: 62, lastActiveMs: 11 * DAY, periodEndDays: 22 }),
  ...
  member({ key: "kaori", discordUsername: "kaori.b", name: "Kaori B.", tier: "coaching", duree: "3mois", status: "past_due", stage: "positionnement", phone: "+33 6 03 45 67 89", inscritDaysAgo: 31, lastActiveMs: 2 * DAY, periodEndDays: -1 }),
  ...
  member({ key: "remi", discordUsername: "remi.ssr", name: "Rémi S.", tier: "coaching", duree: "3mois", status: "active", stage: "onboarding", phone: "+33 6 71 23 45 67", inscritDaysAgo: 4, lastActiveMs: 4 * DAY, periodEndDays: 26 }),
];
...
export const paymentsOverview: Payments = {
  ...
  subscriptions: [
    ...
    sub({ key: "lena", who: "lena__rmr", offre: "Coaching 3 mois", montant: 179, statut: "active", echeanceDays: 7, depuisDays: 62, phone: "+33 6 22 11 09 87" }),
    ...
    sub({ key: "kira", who: "kira.ldn", offre: "Coaching 3 mois", montant: 179, statut: "active", echeanceDays: 7, depuisDays: 92, phone: "+33 6 78 91 02 33" }),
    sub({ key: "kaori", who: "kaori.b", offre: "Coaching 3 mois", montant: 179, statut: "past_due", echeanceDays: null, depuisDays: 31, phone: "+33 6 03 45 67 89" }),
    sub({ key: "amir", who: "amir.flow", offre: "Coaching 3 mois", montant: 179, statut: "active", echeanceDays: 16, depuisDays: 31, phone: "+33 6 87 33 12 09" }),
    sub({ key: "octave", who: "octave.fm", offre: "Coaching 3 mois", montant: 179, statut: "active", echeanceDays: 22, depuisDays: 62, phone: "+33 6 22 09 87 33" }),
    ...
    sub({ key: "remi", who: "remi.ssr", offre: "Coaching 3 mois", montant: 179, statut: "active", echeanceDays: 26, depuisDays: 4, phone: "+33 6 71 23 45 67" }),
  ],
};
