...
> = {
  ...
  alertes: [
    { who: "thibz_prod", type: "Échec paiement", montant: "179 €" },
    { who: "selma.snd", type: "Annulation", montant: "79 €" },
    { who: "kaori.b", type: "Échec paiement", montant: "179 €" },
  ],
  onboarding: [
    { who: "yuko_prod", etape: "Formulaire envoyé", depuis: "2 j" },
    { who: "remi.ssr", etape: "À programmer", depuis: "4 j" },
  ],
  activite: [
    { t: "il y a 12 min", txt: "Paiement reçu — yuko_prod · 179 €" },
    { t: "il y a 1 h", txt: "Nouveau membre — h4nna.wav" },
    { t: "il y a 2 h", txt: "RDV terminé — mxlo.beats · notes ajoutées" },
    { t: "il y a 3 h", txt: "Étape mise à jour — lena__rmr → Feedback" },
    { t: "il y a 5 h", txt: "Paiement reçu — kira.ldn · 79 €" },
    { t: "hier", txt: "Nouveau membre — soren.wav" },
  ],
...
export const getMemberDetail: Detail = {
  ...
  onboarding: {
    _id: "n_mxlo" as unknown as Id<"onboardingNotes">,
